...
const placeOrderHandler = async () => {
  try {
    ...
    const orderItemsPayload = cart.cartItems.map((item) => ({
      product: item.product || item._id, // fallback in case your cart uses _id
      name: item.name,
      qty: item.qty,
      price: item.price,
      image: item.image,
    ...
    console.log("Sending orderItems to backend:", orderItemsPayload);
    ...
    console.error("❌ placeOrderHandler error:", err);
